...
<%--                 <div class="layout">
                ...
                <div class="layout">
                  ...
                  <div class="juicy">
                  <a href="${pageContext.servletContext.contextPath}" class="juicy"><img src="images/layout.png"  class="img2"/></a>
                  <a href="${pageContext.servletContext.contextPath}" class="juicy"><img src="images/ordersheet.png" class="img2"/></a>
                  <a href="${pageContext.servletContext.contextPath}" class="juicy"><img src="images/management.png" class="img2"/></a>
                  </div>
                  <div class="juicy">
                  <a href="${pageContext.servletContext.contextPath}" class="juicy"><img src="images/coupon.png" class="img2"/></a>
                  <a href="${pageContext.servletContext.contextPath}" class="juicy"><img src="images/wishlist.png" class="img2"/></a>
                  <a href="${pageContext.servletContext.contextPath}" data-toggle="modal" data-target="#myModal" class="juicy" id="modalmodal"><img src="images/withdraw.png" class="img2"/></a>
                  </div>
                  <!-- Modal -->
